            ...
            <table class="defaultTable">
                <tr>
                	<c:if test="${fullQuery && empty searchLoansForm.query.member}">
                    	<th width="15%" class="tdHeaderContents"><bean:message key='member.username'/></th>
                    </c:if>
				...
				<c:forEach var="loan" items="${loans}">
	                ...
	                <tr class="<t:toggle>ClassColor1|ClassColor2</t:toggle>">
	                	<c:if test="${fullQuery && empty searchLoansForm.query.member}">
	                		<td align="center"><a class="profileLink" memberId="${loan.member.id}">${loan.member.username}</a></td>
	                	</c:if>
