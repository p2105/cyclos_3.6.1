        ...
        <td colspan="2" align="left" class="tdContentTableForms">
            <table class="defaultTable">
				<tr>
					...
					<td colspan="4">${fee.name}</td>
				</tr>
				<tr>
					<td class="headerLabel" valign="top"><bean:message key='accountFeeLog.date'/></td>
					<td colspan="4"><cyclos:format dateTime="${log.date}"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="4"><cyclos:format amount="${log.amountValue}" unitsPattern="${currencyPattern}"/></td>
				</tr>
				<tr>
					<td class="headerLabel" valign="top"><bean:message key='accountFee.freeBase'/></td>
					<td colspan="4"><cyclos:format number="${empty log.freeBase ? 0.0 : log.freeBase}" unitsPattern="${currencyPattern}"/></td>
				</tr>
				<tr>
					<td class="headerLabel" valign="top"><bean:message key='accountFeeLog.processedMembers'/></td>
					<td colspan="4"><cyclos:format number="${log.totalMembers}"/></td>
				</tr>
				<tr>
					<td class="headerLabel" valign="top"><bean:message key='accountFeeLog.failedMembers'/></td>
					<td colspan="4"><cyclos:format number="${log.failedMembers}"/></td>
				</tr>
				<tr>
					<td class="headerLabel" valign="top"><bean:message key='accountFeeLog.skippedMembers'/></td>
					<td colspan="4"><cyclos:format number="${details.skippedMembers}"/></td>
				</tr>
				<c:if test="${fee.memberToSystem and not invoiceAlways and not invoiceNever}">
					<tr>
						...
						<td colspan="4"><cyclos:format number="${details.transfers.amount + details.acceptedInvoices.amount}" unitsPattern="${currencyPattern}"/></td>
					</tr>
				</c:if>
	            ...
	            <table class="defaultTable" cellspacing="0" cellpadding="0">
					...
					<c:forEach var="entry" items="${members}">
		                ...
		                <tr class="<t:toggle>ClassColor1|ClassColor2</t:toggle>">
							<td><a class="profileLink" memberId="${member.id}">${member[memberProperty]}</td>
