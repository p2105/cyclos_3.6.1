...
public class EditGroupForm extends BaseBindingForm {
    ...
    public EditGroupForm() {
        ...
        final MapBean memberSettings = new MapBean("maxAdsPerMember", "maxAdImagesPerMember", "maxImagesPerMember", "sendPasswordByEmail", "mailValidation", "viewLoansByGroup", "repayLoanByGroup", "groupAfterExpiration");
