		...
		<td colspan="2" align="left">
			<table class="defaultTable">
				<tr>
					...
					<th class="tdHeaderContents" width="20%"><bean:message key="member.username"/></th>
					...
					<tr class="<t:toggle>ClassColor1|ClassColor2</t:toggle>">
						...
						<td align="center">
							<c:choose><c:when test="${fn:contains(relatedAccount['class'].name, 'System')}">
								...
								<a class="profileLink" memberId="${relatedAccount.member.id}">${relatedAccount.ownerName}</a>
							</c:otherwise></c:choose>
						</td>
