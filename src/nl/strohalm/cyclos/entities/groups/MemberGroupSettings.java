...
public class MemberGroupSettings extends DataObject {
    ...
    public static enum EmailValidation implements StringValuedEnum {
        NEVER("N"), EXTERNAL("E"), PUBLIC("P"), PUBLIC_BROKER("B"), ALL("A");
        ...
        public boolean isApplied(final boolean isExternal) {
            final boolean isPublic = !isExternal && !LoggedUser.hasUser();
            final boolean byBroker = LoggedUser.hasUser() && LoggedUser.isBroker();
            switch (this) {
                case ALL:
                    return true;
                case PUBLIC_BROKER:
                    return isPublic || byBroker;
                case PUBLIC:
                    return isPublic;
                case EXTERNAL:
                    return isExternal;
    ...
    public void setEmailValidation(final EmailValidation emailValidation) {
