...
<table class="defaultTable">
	...
	<c:forEach var="ad" items="${ads}">
		<c:set var="memberLink"><a class="profileLink" style="text-decoration:underline" memberId="${ad.owner.id}"><cyclos:truncate value="${ad.owner[ownerProperty]}" length="50"/></a></c:set>
