        ...
        <td class="tdContentTable">
            <table class="defaultTable">
				<tr>
					...
					<td>${payment.from.name} (${payment.from.username})</td>
				</tr>
				<tr>
					<td class="headerLabel"><bean:message key="transfer.to"/></td>
					<td>${payment.to.name} (${payment.to.username})</td>
				</tr>
				<tr>
					<td class="headerLabel"><bean:message key="transfer.amount"/></td>
					<td><cyclos:format number="${finalAmount}" unitsPattern="${payment.ticket.currency.pattern}"/></td>
				</tr>
