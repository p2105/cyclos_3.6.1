...
public class AccountServiceImpl implements AccountServiceLocal {
    ...
    public BigDecimal calculateTransactionedVolume(final TransactionVolumeDTO dto) {
        ...
        final BigDecimal initialBalance = getBalance(new AccountDateDTO(account, period.getBegin()));
    ...
    public boolean canView(final Account account) {
        ...
        if (!canViewAccountsOf(account.getOwner())) {
            return false;
        }
        return accountTypeService.getVisibleAccountTypes().contains(account.getType());
    }
    ...
    public void removeClosedBalancesAfter(final Account account, final Calendar date) {
        if (account.getLastClosingDate() != null && account.getLastClosingDate().after(date)) {
    ...
    public ScheduledPaymentAmountReservation reserve(final ScheduledPayment scheduledPayment) {
        ...
        return amountReservationDao.insert(reservation);
    }
