...
<ul>
	...
	<br>
	<li><b>Run Java class:</b> If specific behavior or functionality is 
	...
	<br>
	<br>
	<li><b>Requires authorization:</b> If selected an extra
	authorization window will appear below this window as soon as you save
	it for the first time. More information about <a
		href="${pagePrefix}payments#authorized"><u>authorized payments</u></a>
	can be found in the help of <a href="#authorized_payment_levels"><u>that
	window</u></a> .<br>
	If you un-select the authorizations option all authorizations levels
	will be canceled for new payments. <br>
	<br>
