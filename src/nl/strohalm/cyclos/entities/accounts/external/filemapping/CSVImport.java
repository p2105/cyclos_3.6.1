...
public class CSVImport implements TransactionFileImport {
    ...
    public CSVImport(final CSVFileMapping mapping) {
        ...
        while ((line = readLine(in)) != null) {
            ...
            for (final FieldMapping field : mapping.getFields()) {
                ...
                try {
                    ...
                    final IllegalTransactionFileFormatException itff = new IllegalTransactionFileFormatException(lineNumber, column + 1, field.getName(), stringValue);
                    itff.initCause(e);
                    throw itff;
                }
            }
