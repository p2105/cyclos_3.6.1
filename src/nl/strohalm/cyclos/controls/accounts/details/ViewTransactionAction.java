...
public class ViewTransactionAction extends BaseFormAction {
    ...
    protected void prepareForm(final ActionContext context) throws Exception {
        ...
        if (context.isMember()) {
            permission = MemberPermission.PAYMENTS_CHARGEBACK;
        } else if (transfer.isFromSystem()) {
            permission = AdminSystemPermission.PAYMENTS_CHARGEBACK;
        } else {
            permission = AdminMemberPermission.PAYMENTS_CHARGEBACK;
        }
