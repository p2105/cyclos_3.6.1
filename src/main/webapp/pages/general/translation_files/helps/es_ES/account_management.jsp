...
<ul>
	<li><b>Nombre:</b> Nombre del tipo de transacción.
	<li><b>Descripción:</b> Descripción interna del tipo de transacción. La misma aparece
	en los detalles de la transacción.<br>
	...
	que serán reemplazados por su correspondiente valor en la descripción de la transacción.
	...
	posible configurar mensajes para tipos de transacción específicos.
	<li><b>Desde:</b> Tipo de cuenta del usuario que efectúa el pago (pagador).
	<li><b>A:</b> Tipo de cuenta del usuario destinatario del pago (cobrador).
	...
	definiendo la configuración de su "prioridad" en blanco.
	...
	Si &quot;Disponibilidad&quot; es mostrada, la opción &quot;Habilitado&quot; no lo será, y viceversa.
	...
	El canal por defecto es &quot;Acceso internet&quot;, pero otros (como SMS) están disponibles.
	...
	Por ejemplo puede ser utilizado para limitar los pagos realizados con teléfonos celulares.
	
	<li><b>Es préstamo:</b> (solo disponible en pagos del sistema a miembros)<br> 
	Seleccione esta opción para indicar si el tipo de transacción es un préstamo. <br>
	Las opciones de configuración del préstamo aparecerán debajo, luego de seleccionar esta opción; por más información 
	<a href="${pagePrefix}loans#make_loan_type"><u>haga click aquí</u></a>.
	
	<li><b>Requiere autorización:</b> Si usted selecciona esta opción, una nuevo cuadro (Niveles de autorización) 
	aparecerá debajo, en el momento en que usted guarde por primera vez el tipo de transacción.<br>
	Por más información sobre <a href="${pagePrefix}payments#authorized"><u>pagos autorizados</u></a>, 
	consulte la ayuda de <a href="#authorized_payment_levels"><u>esta ventana</u></a>.<br>
	Si usted desmarca esta opción, todos sus niveles de autorización serán cancelados para los nuevos/futuros pagos.
	
	<li><b>Permite pagos agendados:</b> Si selecciona esta opción, este tipo de transacción puede ser un pago 
	<a href="${pagePrefix}payments#scheduled"><u>agendado</u></a>.<br> 
	Esto no significa que con solo seleccionar esta opción, los miembros o el administrador puedan con este tipo de transacción agendar pagos. 
	Aún es necesario configurar los permisos correspondientes para el grupo (ver y permitir pagos agendados).<br> 
	Por más información consule el manual de: Pagos - Pagos agendados. 
	...
	<a href="${pagePrefix}bookkeeping"><u>Registro de ingresos y egresos (cuentas externas).</u></a> 
	...
	<br>
	Los siguientes elementos son visibles si la casilla de verificación es seleccionada:
	<ul>
