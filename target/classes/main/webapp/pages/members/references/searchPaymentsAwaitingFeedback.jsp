	            ...
	            <table class="defaultTable">
	                ...
	                <c:forEach var="payment" items="${payments}">
		                <tr class="<t:toggle>ClassColor1|ClassColor2</t:toggle>">
		                    ...
		                    <td align="left"><a class="profileLink" memberId="${payment.memberId}">${payment.memberUsername}</a></td>
		                    <td align="left"><a class="profileLink" memberId="${payment.memberId}">${payment.memberName}</a></td>
