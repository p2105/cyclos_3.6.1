 ...
 * @author luis
 */
public class PaymentCustomFieldsAjaxAction extends BaseAjaxAction {
    ...
    protected void renderContent(final ActionContext context) throws Exception {
        ...
        final RequestDispatcher rd = request.getRequestDispatcher("/pages/payments/paymentCustomFields.jsp");
        if (rd != null) {
