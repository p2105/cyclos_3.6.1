...
public interface AdWebService {
    ...
    @WebMethod
    public AdResultPage fullTextSearch(@WebParam(name = "params")
    FullTextAdSearchParameters params);
    ...
    @Permission(ServiceOperation.ADVERTISEMENTS)
    @WebMethod
    public AdVO load(@WebParam(name = "id")
    long id);
    ...
    @Permission(ServiceOperation.ADVERTISEMENTS)
    @WebMethod
    public AdCategoryVO loadCategory(@WebParam(name = "id")
    long id);
    ...
    @Permission(ServiceOperation.ADVERTISEMENTS)
    @WebMethod
    public AdResultPage search(@WebParam(name = "params")
    AdSearchParameters params);
}
