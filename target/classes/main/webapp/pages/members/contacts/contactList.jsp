				...
				<table class="defaultTable">
					...
					<c:forEach var="contact" items="${contacts}">
						<tr class="<t:toggle>ClassColor1|ClassColor2</t:toggle>">
	   						<td><a class="profileLink" memberId="${contact.contact.id}">${contact.contact.username}</a></td>
	   						<td><a class="profileLink" memberId="${contact.contact.id}">${contact.contact.name}</a></td>
	   						<td>
