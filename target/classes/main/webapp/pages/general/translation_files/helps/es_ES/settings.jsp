...
<ul>
	...
	Este nombre es utilizado en el caso de acceso de un software de terceros a Cyclos y es necesario identificar la conexión. 
	Normalmente, este es el nombre de la instancia.
...
<ul>
	...
	<ul>
		...
		la longitud mínima y máxima del código de usuario ("Largo de código de usuario en conexión manual"), y 
		una expresión regular ("Expresión común para nombre de conexión") para forzar el formato del código de usuario. <br>
		...
		Debajo de esta opción ("Largo de código de usuario generado"), usted puede especificar la longitud del código a generar.</li>
	</ul>
	<br>
...
<ul>
	...
	Aquí usted puede especificar la dirección IP o el nombre de dominio (resuelto como una dirección IP), 
	a la que se le permite el acceso al web services.<br>
	...
	conexiones externas. También es posible especificar un rango de direcciones IP (ej.: 77.88.45.1-256).<br>
