...
<ul>
	...
	<li><b><bean:message key='alert.system.INDEX_OPTIMIZED'/></b>: Opimización del índice de búsqueda.<br>
	<!--<i><u>Notificación</u>: El índice de búsqueda para {?} fue optimizado</i>.-->
