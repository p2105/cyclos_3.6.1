...
<ul>
	...
	<span class="admin broker">
		...
		Accounts: view invoices</b> allows you to view the invoices of a specific member.</li>
	</span>
	<span class="member">
		<li><b>Menu: Account > System invoice: </b> allows you to send invoices to the organization.
		</li>
		<li><b>Menu: Account > Member invoice:</b> allows you to send invoices to another member.</li>
		<li><b>Menu: Account > invoices:</b> lets you view and manage all your
		incoming and outgoing invoices.	</li>
		<li><b>Member <a href="${pagePrefix}profiles"><u>profile</u></a> >
...
It is possible for a member to send an <a href="#top"><u>invoice</u></a> to the system 
(organization). The organization administrator will receive the invoice and will either accept or
reject it. When an administrator accepts or rejects an invoice you will receive
a notification in your personal news message section informing you about the action.<br>
...
</u></a> sent from System accounts to Member accounts (outgoing invoices) and invoices 
from Member accounts to System accounts (incoming invoices).
