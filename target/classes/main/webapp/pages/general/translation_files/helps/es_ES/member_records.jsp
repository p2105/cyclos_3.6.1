...
<ul>
	...
	<li><b>Código de miembro / Nombre:</b> Permite buscar los registros por el miembro al que son asignados.
	<li><b>Fecha de creación:</b> Permite buscar registros por su fecha de creación (asignada automáticamente).
</ul>
