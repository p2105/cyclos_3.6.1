...
public class Setup {
    ...
    public static void main(final String... args) throws IOException {
        ...
        final Setup setup = Arguments.buildSetupFromArguments(args);
        setup.locale = resolveLocale();
    ...
    public boolean isValid() {
        return createDataBase || exportScriptTo != null || createBasicData || createInitialData;
    }
