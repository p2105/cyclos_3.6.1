...
<br><br>
Para registrar un nuevo miembro en el sistema, usted deberá utilizar el menú desplegable "Crear un miembro", 
...
al <a href="#create_user"><u>Formulario de registro</u></a> (crear un miembro).
<hr class="help">
</span>
...
<ul>
	...
	en el estado pendiente y/o estado activo. En ambos casos la tarjeta existente será cancelada.</li>
</ul>
