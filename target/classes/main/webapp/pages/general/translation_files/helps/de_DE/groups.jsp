...
<ul>
	...
	Diese Einstellung wird verwendet, wenn Sie über eine Website Zugriff auf Cyclos nehmen möchten. 
	Die Einstellung funktioniert genau wie die globale Containerseite  
	(siehe <a href="${pagePrefix}settings#local"><u>Einstellungen >	Basiseinstellungen</u></a> aber nur für diese Gruppe. 
...
<ul>
	...
	<li><b>Mitgliedsprofil:</b> 
	  <ul>
		...
		im Profil ändern. 
		<li><b>Namen ändern:</b> (selbsterklärend)  
    </ul>
