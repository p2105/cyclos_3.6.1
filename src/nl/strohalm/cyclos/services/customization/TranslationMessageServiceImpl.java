...
public class TranslationMessageServiceImpl implements TranslationMessageServiceLocal, InitializingBean, InitializingService {
    ...
    private void clearCacheAndNotifyListeners() {
        getCache().clear();
        // The listeners notification will happen when the new value for PROPERTIES_KEY is stored on the cache. To do so, let's force a re-read
        exportAsProperties();
    }
