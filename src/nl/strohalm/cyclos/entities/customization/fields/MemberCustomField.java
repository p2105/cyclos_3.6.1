...
public class MemberCustomField extends CustomField {
    ...
    public static enum Access implements StringValuedEnum {
        NONE("N"), ADMIN("A"), BROKER("B"), REGISTRATION("R"), MEMBER_NOT_REGISTRATION("T"), MEMBER("M"), OTHER("O"), MEMBER_NOT_OPERATOR("P");
         ...
         */
        public boolean granted(final Group group) {
            switch (this) {
                case NONE:
                    return false;
                case BROKER:
         ...
         */
        public boolean granted(final Group group, final boolean byOwner, final boolean byBroker, final boolean atRegistration) {
