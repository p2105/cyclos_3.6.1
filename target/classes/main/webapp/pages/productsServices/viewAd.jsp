        ...
        <td colspan="2" align="left" class="tdContentTableForms">
            <table class="defaultTable">
                <tr>
                    ...
                    <td><bean:message key="ad.tradeType.${ad.tradeType}"/></td>
                ...
                <tr>
                    ...
                    <td>
                    	<a class="profileLink" style="text-decoration:underline" memberId="${ad.owner.id}">${ad.owner[localSettings.memberResultDisplay.property]}</a>
                    </td>
				</tr>
