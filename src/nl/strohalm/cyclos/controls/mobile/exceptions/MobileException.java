...
public class MobileException extends ApplicationException {
    ...
    public MobileException() {
        this(true, null, null, (String[]) null);
    }

    public MobileException(final boolean withTitle, final String titleKey, final String messageKey, final String... args) {
    ...
    public MobileException(final String messageKey) {
        this(true, null, messageKey, (String[]) null);
    }

    public MobileException(final String messageKey, final String... args) {
