			        	...
			        	<tr>
							<td colspan="4">
									<fieldset>
										...
										<cyclos:layout className="defaultTable" columns="4">	
										<tr>
											<td class="label tdHeaderContents" width="30%"><bean:message key="member.username"/></td>
							                <td><a style="text-decoration:underline;" class="profileLink default" memberId="${card.owner.id}">${card.owner.username}</a>
										</tr>
										<tr>		                	
