           		...
           		<table class="defaultTable">
		        	<c:if test="${showPayment}">
		            	...
		            	<tr>
		            		...
		            		<td><cyclos:format number="${payment.amount}" unitsPattern="${payment.from.type.currency.pattern}" /></td>
		            	</tr>
			        </c:if>
	            	<tr>
	            		...
	            		<td>
	            			...
	            			<a class="default profileLink" memberId="${fromMember.id}">${fromMember.name}</a>
	            		</td>
	            	</tr>
	            	<tr>
	            		...
	            		<td>
	            			...
	            			<a class="default profileLink" memberId="${toMember.id}">${toMember.name}</a>
	            		</td>
	            	</tr>
		        	<c:if test="${showPayment}">
		            	<tr>
	            ...
	            <table class="defaultTable">
	            	<c:if test="${transactionFeedback.persistent}">
		            	<tr>
		            		...
		            		<td><cyclos:format dateTime="${transactionFeedback.date}" /></td>
		            	</tr>
		            </c:if>
	                <tr>
	                    <td class="headerLabel" width="25%"><bean:message key="reference.from"/></td>
	                    <td>${transactionFeedback.from.name}</td>
	                </tr>
	                <tr>
		            ...
		            <table class="defaultTable">
		            	<c:if test="${not empty transactionFeedback.replyComments}">
			            	<tr>
			            		...
			            		<td><cyclos:format dateTime="${transactionFeedback.replyCommentsDate}" /></td>
			            	</tr>
			            </c:if>		            	
		                <tr>
		                    <td class="headerLabel" width="25%"><bean:message key="reference.from"/></td>
		                    <td>${transactionFeedback.to.name}</td>
		                </tr>
		                <tr>
		            ...
		            <table class="defaultTable">
		            	<c:if test="${not empty transactionFeedback.adminComments}">
			            	<tr>
			            		...
			            		<td><cyclos:format dateTime="${transactionFeedback.adminCommentsDate}" /></td>
			            	</tr>
			            </c:if>		            	
		                <tr>
