...
<ul>
	...
	It is also possible to specify an IP range (e.g. 77.88.45.1-256). Note
	...
	preferable only allowing a single IP address.<br>
...
startup of Cyclos the initialization process will created them. Over
time you might want to optimize the index after much time of use (and
much data).<br>
...
rebuild and optimize indexes per index type. If needed you can rebuild
