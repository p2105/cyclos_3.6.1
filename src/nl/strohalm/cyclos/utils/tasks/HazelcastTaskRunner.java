 ...
 * @author luis
 */
public class HazelcastTaskRunner extends TaskRunnerImpl implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        initializationControl = Hazelcast.getMap("cyclos.initializationControl");
        scheduledTaskControl = Hazelcast.getMap("cyclos.scheduledTaskControl");
    }
