            ...
            <table class="defaultTable">
            	...
            	<c:if test="${isAdmin}">
	                <tr class="toHideGroups">
	                    ...
	                    <td>
	           				<cyclos:multiDropDown varName="groupsMdd" name="smsMailing(groups)" emptyLabelKey="member.search.allGroups">
                ...
                <tr>
                    ...
                    <td><html:textarea property="smsMailing(text)" rows="3" styleId="text" styleClass="full"/></td>
                </tr>
                <tr>
