            ...
            <table class="defaultTable">
				...
				<c:if test="${not empty fromMember}">
					<tr>
						...
						<td>${fromMember.username} - ${fromMember.name}</td>
					</tr>
				</c:if>
				<tr>
				...
				<tr>
					...
					<td><bean:message key='scheduledPayment.transferNumber' arg0="${transferNumber}" arg1="${numberOfTransfers}"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><cyclos:format rawDate="${transfer.date}" /></td>
				</tr>
				<tr>
