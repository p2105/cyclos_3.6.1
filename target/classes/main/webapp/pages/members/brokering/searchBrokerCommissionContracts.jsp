...
<c:choose>
	<c:when test="${empty brokerCommissionContracts}">
		<div class="footerNote"><bean:message key="brokerCommissionContract.search.noResults"/></div>
	</c:when><c:otherwise>
		<table class="defaultTableContent" cellspacing="0" cellpadding="0">
		    <tr>
		            ...
		            <table class="defaultTable">
		                ...
		                <c:forEach var="brokerCommissionContract" items="${brokerCommissionContracts}">
		                	...
		                	<tr class="<t:toggle>ClassColor1|ClassColor2</t:toggle>">
			                    ...
			                    <td align="center"><a class="profileLink" memberId="${member.id}">${member.name}</a></td>
