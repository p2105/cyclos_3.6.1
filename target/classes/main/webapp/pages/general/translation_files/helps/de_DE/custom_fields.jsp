...
und <a href="${pagePrefix}loan_groups"><u>Darlehensgruppen</u></a>, und für 
<a href="${pagePrefix}member_records"><u>Mitgliedseinträge</u></a>.<br>
...
Felder; einige der Felder sind so wichtig, dass sie weder entfernt noch bearbeitet werden können.
...
<ul>
	...
	<ul>
		<li>Textbereich (eine Zeile oder ein Textfeld (5 Zeilen) für eine Zeichenkette (Text).
