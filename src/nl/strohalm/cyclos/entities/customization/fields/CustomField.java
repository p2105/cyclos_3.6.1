...
public abstract class CustomField extends Entity {
    ...
    public static enum Control implements StringValuedEnum {
        TEXT("text", true), TEXTAREA("textarea", true), RICH_EDITOR("richEditor", false), SELECT("select", true), RADIO("radio", true), CHECKBOX("checkbox", false);
    ...
    public static enum Nature implements StringValuedEnum {
        AD("ad"), ADMIN("admin"), PAYMENT("payment"), LOAN_GROUP("loan_group"), MEMBER("member"), OPERATOR("op"), MEMBER_RECORD("member_record");
    ...
    public static enum Type implements StringValuedEnum {
        STRING("string", Control.TEXT, Control.TEXTAREA, Control.RICH_EDITOR), ENUMERATED("enum", Control.SELECT, Control.RADIO), INTEGER("integer", Control.TEXT), BIG_DECIMAL("bigDecimal", Control.TEXT), DATE("date", Control.TEXT), BOOLEAN("boolean", Control.CHECKBOX), URL("url", Control.TEXT);
    ...
    public Collection<CustomFieldPossibleValue> getPossibleValuesByParent(final CustomFieldPossibleValue parentValue) {
