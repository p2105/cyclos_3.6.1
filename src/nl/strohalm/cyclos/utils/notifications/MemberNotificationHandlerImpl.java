...
public class MemberNotificationHandlerImpl implements MemberNotificationHandler {
    ...
    @Override
    public void scheduledPaymentProcessingNotification(final Transfer transfer, final boolean notifyPayer) {
        notifyScheduledPaymentProcessing(transfer, notifyPayer);
    }
