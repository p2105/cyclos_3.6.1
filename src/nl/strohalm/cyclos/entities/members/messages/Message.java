...
public class Message extends Entity {
    ...
    private List<Member>      pendingToSend;
    ...
    public List<Member> getPendingToSend() {
    ...
    public void setEmailsSent(final int emailsSent) {
    ...
    public void setMessagesSent(final int messagesSent) {
        this.messagesSent = messagesSent;
    }

    public void setPendingToSend(final List<Member> pendingToSend) {
