...
Aquí usted puede modificar las propiedades de un <a href="#admin_groups"><u>grupo
Administrador</u></a>.<br>
Luego de hacer click en el botón "Modificar", puede modificar el Nombre,
Descripción (detalles) y su "Configuración de acceso". <br>
<br><br>Advierta que aquí no es posible configurar sus permisos; los
...
de permisos <img border="0" src="${images}/permissions.gif" width="16"
...
<br><br>Los siguientes campos están disponibles para establecer la <b>Configuración
de acceso</b> del grupo:
<ul>
	...
	<br>
	<li><b>Máximo de intentos por contraseña errónea:</b> Cuando el
	usuario alcanza la cantidad máxima de intentos definida, pierde la
	posibilidad de volver a ingresar al sistema hasta que se alcance el
	tiempo de reactivación (ver siguiente parámetro).<br>
	<li><b>Tiempo de desactivación por contraseña errónea:</b> Este es
...
<ul>
	...
	<li><b>URL de la página contenedora:</b> 
...
<ul>
	...
	<br>
	<li><b>Validación de correo electrónico:</b> Cuando esta opción es
	seleccionada, la validación de correo electrónico es requerida.<br>
	Luego de su registro, el usuario recibirá en su dirección de correo
	electrónico un e-mail de confirmación (activación), que deberá
	responder con el fin de que el registro sea procesado.<br>
	<br>
	...
	"pendiente". <br>
	El período máximo de confirmación puede ser definido en la en la
	...
	pendientes</u></a>.<br>
	<br>
	Las siguientes opciones de validación se encuentran disponibles:
	<ul>
		<li><b> Nunca: </b> El e-mail NO es validado.<br>
		El miembro forma parte directamente del grupo inicial que se establece
		en el registro público.<br>
		(en el caso de un registro por admin/broker, forma parte del grupo
		seleccionado por el administrador o broker)
		<li><b> Sólo en el registro externo:</b> El e-mail es validado
		solamente cuando los miembros son registrados de forma externa (por
		ejemplo: canal SMS).
		<li><b> Sólo en el registro público:</b> El e-mail es validado
		solamente cuando los miembros son registrados a través de la página de
		registro público.
		<li><b> En el registro público ó por broker:</b> El registro se
		valida: cuando los miembros se registran a través de la página de
		registro público, y también cuando los brokers registran al miembro.
		<li><b> En todos los registros (admin/broker/público):</b> (Auto
		explicativo).
	</ul>
	<br>
	...
	del sistema.<br>
	Si usted desea utilizar esta opción, asegúrese que el campo de correo
	correo electrónico sea obligatorio.<br>
...
<ul>
	...
	para los usuarios que se encuentren conectados en la página de POSWeb.
</ul>
<hr class="help">
...
<ul>
	...
	<li><b>Monedas:</b> Permite al administrador ver y/o gestionar
	diferentes <a href="${pagePrefix}account_management#currencies"><u>monedas</u></a>
	en Cyclos.
	<ul>
		<li><b><a href="#manage_permissions_admin"><u>Administrar</u></a></b></li>
		<li><b><a href="#view_permissions_admin"><u>Ver</u></a></b></li>
	...
	<ul>
		...
		<li><b>Autorizar:</b> Permiso para <a
			href="${pagePrefix}payments#authorized"><u>autorizar</u></a> pagos de
		sistema.
		<li><b>Cancelar:</b> Permiso para cancelar <a
			href="${pagePrefix}payments#scheduled"><u>pagos agendados</u></a>.
	...
	<ul>
		...
		<li><b>Mensajes SMS enviados:</b> El sistema puede enviar
		...
		<li><b>Simulación de configuración de ratio-A</b></li>
	</ul>
	<br>
	...
	<ul>
		...
		/ importar a archivo</u></a></b>
		<li><b><a href="${pagePrefix}settings#access"><u>Configuración
		de acceso</u></a></b>
		<li><b><a href="${pagePrefix}settings#alerts"><u>Configuración
		de alertas</u></a></b>
		<li><b><a href="${pagePrefix}settings#local"><u>Configuración
		local</u></a></b>
		<li><b><a href="${pagePrefix}settings#log"><u>Configuración
		de archivo de registro</u></a></b>
		<li><b><a href="${pagePrefix}settings#mail"><u>Configuración
		de mensajería</u></a></b>
		<li><b><a href="${pagePrefix}settings#settings"><u>Ver
		configuración</u></a>:</b> Si esta opción no es seleccionada, el administrador no
		podrá visualizar el menú de configuración (Menú: Configuración).</li>
	</ul>
	...
	<ul>
		...
		<li><b>Seleccionar:</b> Permite seleccionar/establecer un tema en
		el sistema.
	</ul>
	<br>
	...
	Los permisos disponibles son:
	<ul>
		<li><b>Importar / exportar a un archivo:</b> Permite importar o
		exportar las traducciones del sistema a un archivo.
		<li><b><a href="#manage_permissions_admin"><u>Administrar</u></a></b></li>
		<li><b>Traducción de correos electrónicos:</b> Permite realizar
		la traducción de los textos correspondientes a los correos
		electrónicos enviados por el sistema.
		<li><b>Notificación:</b> Permite realizar la traducción de los
		textos correspondientes a las notificaciones del sistema.
		<li><b><a href="#view_permissions_admin"><u>Ver</u></a></b></li>
	</ul>
	<br>
</ul>
...
<ul>
	...
	<ul>
		<li><b>Cambiar contraseña de acceso al sistema:</b> Permite al
		...
		<li><b>Limpiar contraseña de acceso al sistema:</b> Permite al
		...
		<li><b>Reactivar miembros deshabilitados (por intentos
		fallidos de ingreso de contraseña):</b> Si un miembro olvida su contraseña
		de acceso e intenta acceder varias veces al sistema con la contraseña
		...
		<li><b>Modificar PIN:</b> Permite al administrador cambiar el <a
	...
	<ul>
		...
		etc).
		<li><b>Ver pagos autorizados:</b> Le permite al administrador
	...
	<ul>
		...
		<li><b>Enviar factura desde perfil:</b> Si esta opción es
		seleccionada, estará accesible en el perfil de los miembros, el botón
		de acción "Factura del sistema al miembro" (bloque Cuentas).</li>
	...
	<ul>
		...
		<li><b>Bloquear</b>.</li>
		<li><b>Descartar</b>.</li>
		<li><b>Modificar contraseña</b>.</li>
	...
	<li><b>Mensajes SMS de difusión:</b> Permite al administrador
	...
	<ul>
		...
		de usuarios.
		<li><b>Cambiar perfil:</b> Si esta opción es seleccionada, el
		...
		<li><b>Cambiar grupo:</b> Permite al administrador cambiar a un
		Miembro de grupo.
		...
		<li><b>Cambiar el código de cliente:</b> Permite al administrador
		modificar el código de miembro, en el perfil del miembro.</li>
		<li><b>Cambiar el nombre de cliente:</b> Permite al administrador
...
<ul>
	<li><b>Acceso:</b> Esta sección define los permisos de acceso al
	sistema para el grupo.
	<ul>
	...
	<li><b>Cuenta:</b> Los miembros siempre tienen acceso a sus
	cuentas, por lo que no existen permisos para Ver/Administrar sus
	propias cuentas.<br>
	...
	<li><b>Anuncios:</b> Esta sección establece los permisos del grupo
	sobre los anuncios en el sistema.
	<ul>
	...
	<li><b>Comisiones:</b> Esta sección define los permisos
	...
	<li><b>Documentos:</b> Mediante esta opción se puede determinar
	...
	<li><b>Garantías:</b> Permisos correspondientes al módulo de 
	...
	<li><b>Facturas:</b> Esta sección define los permisos sobre las <a
		href="${pagePrefix}invoices"><u>facturas</u></a> en el sistema.<br>
	Los permisos disponibles son:
	<ul>
	...
	<li><b>Préstamos:</b> Esta sección establece los permisos sobre
	...
	<li><b>Mensajes:</b> Aquí usted puede establecer los permisos de
	los miembros para la utilización del sistema de <a
		href="${pagePrefix}messages"><u>mensajes</u></a> (mensajería interna)
	de Cyclos.<br>
	Los permisos disponibles son:
	<ul>
		<li><b>Ver:</b> Si esta opción es seleccionada, la opción
	...
	<li><b>Preferencias:</b> Aquí usted puede definir para los
	...
	<ul>
		...
		administrar sus <a href="${pagePrefix}ads_interest"><u>anuncios
		de interés</u></a>.
	</ul>
	<br>

	<li><b>Perfil de Miembro:</b> Esta sección establece los permisos
	sobre los perfiles de otros miembros (grupos) en el sistema.
	<ul>
		...
		visualización entre grupos.</li>
	</ul>
	<br>

	<li><b>Referencias:</b> Esta sección define los permisos
	...
	<li><b>Reportes de Miembro:</b> Esta sección establece los
	...
	<li><b>Registros de SMS:</b> Esta sección define los permisos
...
<ul>
	...
	<ul>
		...
		<li><b>Negar como miembro:</b> Permite al broker rechazar una
		factura como si fuese el miembro (receptor de la factura).</li>
	...
	<ul>
		...
		<li><b>Restaurar contraseña:</b> Le permite al broker restaurar
...
<ul>
	<li><b>Nombre:</b> Elija el nombre que desea para el nuevo filtro
	de grupo.
	<li><b>Descripción:</b> Descripción utilizada para clarificar el
	uso del filtro de grupo.
	<li><b>Mostrar en perfil:</b> Si esta opción es seleccionada, el
	filtro de grupo será mostrado en el <a href="${pagePrefix}profiles"><u>perfil</u></a>
	del miembro.
	<li><b>Grupos:</b> Opción más importante del formulario. Aquí debe
	seleccionar los grupo integrantes del filtro.
	<li><b>Visible por:</b> Permite seleccionar los grupos que podrán
	visualizar el filtro de grupo en las búsquedas de miembros y anuncios
	del sistema.<br>
	...
	independientemente de los grupos seleccionados en "Mostrado por". Por
	lo tanto esta configuración afecta únicamente la función de búsqueda.
</ul>
<hr class="help">
