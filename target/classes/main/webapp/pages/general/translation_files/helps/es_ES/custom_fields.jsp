...
Luego del campo estar en uso, será imposible modificarlo. <br>
	...
	<ul>
		...
		<!-- VER CON ANDRES, NO ENTIENDO 100% EL FUNCIONAMIENTO DE "TODAS LAS ETIQUETAS SELECCIONADAS" -->
		...
		<li> <b> Boolean: </b> Boolean es un campo que podrá tomar dos posibles valores: Verdadero o Falso.
	</ul>
	<br>
