...
<a name="top"></a>
<br><br>ローングループは、複数のメンバーがローンに対して集団的に責任を持つことを可能にします。<br>
ローングループにローンを与えることは、そのローングループに責任のあるメンバーがローンを受け取ることを意味します。
すべてのメンバーは、そのローンを見ることができ、そのローンを返済することもできます。
<i>どこで見つけられる？</i>
<br>
ローングループには、
<span class="admin">「メニュー: ユーザーとグループ: ローングループ」を通じてアクセスできます。<br>
この項目を見るには、管理者は正しい<a
	href="${pagePrefix}groups#manage_group_permissions_admin_member"><u>許可</u></a>（ローングループブロック）を持つ必要があります。<br><br>
...
<br><br>必要なフィールドに記入した後、「検索」をクリックすると、下の<a href="#search_loans_group_result"><u>
...
これはそのローングループに未決済のローンがない場合にのみ可能です。<br><br>
