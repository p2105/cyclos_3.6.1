	    	  	...
	    	  	<table class="defaultTable">
					...
					<c:forEach var="log" items="${pos.posLog}" varStatus="idx">
						<tr class="<t:toggle>ClassColor1|ClassColor2</t:toggle>">
							...
							<td align="center"><cyclos:truncate value="${log.by.username}"/></td>
							<c:choose>
							...
							<td align="center"><a class="profileLink" memberId="${log.assignedTo.id}"><cyclos:truncate value="${log.assignedTo.username}"/></a></td>
						</tr>						
					</c:forEach>
				</table>
			</td>
