...
同一のシステム内に様々なタイプの仲介者グループが存在し得ます。</span>
仲介者が各々の個人メンバーとの委託手数料に関する
<a href="#commission_contracts"><u>契約</u></a>を設けることが可能です。

<br><br><span class="broker"> <i>どこで見つけられる？</i><br>
...
<br><br>上で指摘したように、取引タイプ設定内で管理者として委託手数料を定義および有効化せずに、仲介者またはメンバーに委託手数料へのアクセスを与えることは、何の意味も成さないということに<b>留意</b>して下さい。
...
その状態は常に「保留中」です。
なせなら、その契約はそのメンバーが承諾または拒否した場合にのみ、別の状態に移り得ますが、あなたがちょうど作成中の時にはそれは不可能だからです。<br><br>
あなたは「開始日」、「終了日」、新しい契約のための額を設定しなければなりません。
日付については、
<img border="0" src="${images}/calendar.gif" width="16" height="16">&nbsp;アイコン<br><br>によって、日付選択機能を使っても良いでしょう。
一度アクティブになると、委託手数料契約は消去できません。
ただし、「キャンセル」ボタンをクリックすることにより、その契約を
