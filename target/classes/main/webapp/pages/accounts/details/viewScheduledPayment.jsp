            	...
            	<tr>
            		...
            		<td>
            			<c:choose><c:when test="${payment.fromSystem}">
            				...
            				<a style="text-decoration:underline;" class="profileLink default" memberId="${payment.from.owner.id}">${payment.from.owner.username} - ${payment.from.owner.name}</a>
            	...
            	<tr>
            		...
            		<td>
            			<c:choose><c:when test="${payment.toSystem}">
            				...
            				<a style="text-decoration:underline;" class="profileLink default" memberId="${payment.to.owner.id}">${payment.to.owner.username} - ${payment.to.owner.name}</a>
            			</c:otherwise></c:choose>
            		</td>
            	</tr>
            	<c:if test="${showBy}">
