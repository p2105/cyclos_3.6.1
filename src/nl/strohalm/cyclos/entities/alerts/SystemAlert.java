...
public class SystemAlert extends Alert {
    ...
    public static enum Alerts implements StringValuedEnum, AlertType {
        ...
        /**
         * Alert when an index has been optimized. Arguments: 0: The index type 1: The server instance id
         */
        INDEX_OPTIMIZED,
        ...
        /**
         * When a rate initialization is finished, this alert is fired. It means the system can be put online again.
         */
        RATE_INITIALIZATION_FINISHED,

        /**
         * A Rate initialization has started. The system has been set offline, and cannot be set online until it is finished.
         */
