...
<ul>
	...
	<li><b>Benutzername / Name:</b> ermöglichen Ihnen die Suche in Einträgen des Benutzers, 
	dem sie zugeordnet sind. 
	<li><b>Erstellungsdatum:</b> kann verwendet werden, um Mitgliedseinträge nach Erstellungsdatum 
